...
![](img/2019-5/1.png)
	...
	###图中另外两个类，就是具体实现了，最主要是ThreadPoolExecutor
![](img/2019-5/3.png)
...
<ul>3.newFixedThreadPool：</ul>
	...
	这里可以看到，corePoolSize和maximumPoolSize都是设的一样的，而且keepAliveTime=0，说明根本不需要规定核心线程数这种东西，完全是定长，因此，用的也是无界队列LinkedBlockingQueue
